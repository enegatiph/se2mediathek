...
public class VormerkMedienFormatierer
{
    ...
    /**
     * Initialisiert einen neuen {@link VormerkMedienFormatierer} für das
     * angegebene {@link Medium}.
     * 
     * @param medium
     *            Ein adaptiertes Medium.
     * @param entleiher
     *            Der aktuelle Entleiher, kann null sein.
     * @param vormerker1
     *            Der erste Vormerker, kann null sein.
     * @param vormerker2
     *            Der zweite Vormerker, kann null sein.
     * @param vormerker3
     *            Der dritte Vormerker, kann null sein.
     * 
     * @require medium != null
     */
    ...
    /**
     * Gibt den Namen des dritten Vormerkers zurück.
     * Der String ist leer, wenn kein dritter Vormerker existiert.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt den Namen des zweiten Vormerkers zurück.
     * Der String ist leer, wenn kein zweiter Vormerker existiert.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt den Namen des ersten Vormerkers zurück.
     * Der String ist leer, wenn kein erster Vormerker existiert.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt den Namen des Entleihers zurück.
     * Der String ist leer, wenn kein Entleiher existiert.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt eine Stringdarstellung des Kunden zurück.
     * Der String ist leer, wenn der übergebene Kunde null ist.
     * 
     * @param kunde
     *          Der Kunde. Kann null sein. 
     * 
     * @ensure result != null
     */
