...
/**
 * Ein {@link AusleiheMedienTableModel} hält Medien, und gibt für jede Spalte im
 * {@link AusleihWerkzeug} die dort benötigte Information über das Medium in
 * einer Zeile zurück.
 * 
 * @author SE2-Team
 * @version SoSe 2012
...
public class AusleiheMedienTableModel extends AbstractTableModel
{
    ...
    /**
     * Initialisiert ein {@link AusleiheMedienTableModel}.
     */
    ...
    /**
     * Liefert ein {@link Medium}, das in der Zeile mit einer gegebenen Nummer
     * dargestellt wird.
     * 
     * @param zeile
     *            Eine Nummer einer Tabellenzeile
     * 
     ...
     * 
     * @param index
     *            Der Index eines Medien-Formatierers in der Medien-Liste.
