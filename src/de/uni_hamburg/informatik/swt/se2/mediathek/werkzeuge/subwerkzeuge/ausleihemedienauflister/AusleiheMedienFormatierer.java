...
public class AusleiheMedienFormatierer
{
    ...
    /**
     * Initialisiert einen neuen {@link AusleiheMedienFormatierer} für das angegebene
     * {@link Medium}.
     * 
     * @param medium
     ...
     * @param ersterVormerker
     *            Der erste Vormerker des Mediums, sofern es vorgemerkt ist.
     *
     * @require medium != null
     */
    ...
    /**
     * Gibt das {@link Medium} des Formatieres zurück.
     * 
     * @return Das {@link Medium} des Formatieres.
     */
