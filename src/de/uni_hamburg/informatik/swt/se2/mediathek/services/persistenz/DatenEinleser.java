...
/**
 * Ein {@link DatenEinleser} kann verwendet werden um Kunden, Medien und
 * Verleihkarten einzulesen.
 * 
 * @author SE2-Team
 * @version SoSe 2012
 */
public class DatenEinleser
{
    ...
    /**
     * Initialisiert einen neuen {@link DatenEinleser}, der aus den angebenen Dateien
     * einliest.
     * 
     * @param medienDatei
     *            Die Datei in der die Medien gespeichert sind.
     ...
     * 
     * Das Ergebnis des Einlesens kann mit {@link #getKunden()},
     * {@link #getMedien()} und {@link #getVerleihkarten()} abgefragt werden.
     * 
