...
/**
 * Mit Hilfe von {@link Verleihkarte}n werden beim Verleih eines {@link Medium}s
 * alle relevanten Daten notiert.
 * 
 ...
 * 
 * Wenn Medien zurück gegeben werden, kann die zugehörige {@link Verleihkarte}
 * entsorgt werden. Um die Verwaltung der Karten kümmert sich der
 * {@link VerleihService}
 * 
 * @author SE2-Team
 * @version SoSe 2012
...
public class Verleihkarte
{
     ...
     * 
     * @ensure {@link #getEntleiher()} == entleiher
     * @ensure {@link #getMedium()} == medium
     * @ensure {@link #getAusleihdatum()} == ausleihdatum
     */
    ...
    /**
     * Gibt das {@link Medium}, dessen Ausleihe auf der Karte vermerkt ist,
     * zurück.
     * 
    ...
    {
        return _medium.berechneMietgebuehr(_ausleihdatum, Datum.heute());
    }

    /**
     * Berechnet die Ausleihdauer in Tagen.
     * 
     * @return Die Ausleihdauer in Tagen.
     */
    public int getAusleihdauer()
    {
        return Datum.heute().tageSeit(getAusleihdatum());
    }
